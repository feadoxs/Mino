...
import { useCartTodoMutation, useGetTodoQuery } from '../../api/todoApi';
...
const Turkish = () => {
    ...
    const { data: turkish, error, isLoading } = useGetTodoQuery();
        ...
        <>
            ...
            <section className='pt-[140px]'>
                <div className='max-w-[1200px] m-[auto] lg:p-[0_30px]'>
                    <p className='text-[#6e7072] font-[Montserrat-medium] tracking-[1.5] text-[15px] dark:text-[#b7b7b7]' data-aos="fade-down" data-aos-duration="1500">{t("turkish.city")}</p>
                    <h1 className='text-[#2d2e2f] font-[Montserrat-bold] dark:text-[white] text-[26px] mt-[8px] mb-[40px]' data-aos="fade-down" data-aos-duration="1500">{t("turkish.title")}</h1>
